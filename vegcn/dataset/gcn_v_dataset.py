...
from utils import (read_meta, read_probs, l2norm,
                   knns2ordered_nbrs, fast_knns2spmat, row_normalize,
                   build_symmetric_adj, sparse_mx_to_indices_values,
                   intdict2ndarray, Timer)
from utils.get_knn import build_knns  # NEW
# from utils.knn import build_knns  # OLD
    ...
    def __init__(self, cfg):
        ...
        with Timer('read knn graph'):
            if os.path.exists(self.knn_graph_path):
                ...
                knns = build_knns(self.features, self.knn_method, self.k)  # shape=(n, 2, k) NEW
